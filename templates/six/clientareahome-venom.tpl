...
{* VENOM DRM - SaaS Licensing Portal Home *}
{* Customized to show only: Licenses, Support Tickets, Invoices, Knowledgebase *}
...
<div class="tiles clearfix">
    <div class="row">
        ...
        {* Knowledgebase Tile *}
        <div class="col-sm-3 col-xs-6 tile" onclick="window.location='knowledgebase.php'">
            <a href="knowledgebase.php">
                <div class="icon"><i class="fas fa-book"></i></div>
                <div class="stat"><i class="fas fa-search"></i></div>
                <div class="title">{$LANG.knowledgebasetitle}</div>
